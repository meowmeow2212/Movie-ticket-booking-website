...
import { phim_hot_nhat } from "./../modules/Url";
...
class PhimHotNhat extends Component {
  componentDidMount() {
...
const mapDispatchToProps = (dispatch) => {
  return {
    fetchListMovie: () => {
      dispatch(actListMovieApi(phim_hot_nhat));
    },
  };
};

export default connect(mapStateToProps, mapDispatchToProps)(PhimHotNhat)